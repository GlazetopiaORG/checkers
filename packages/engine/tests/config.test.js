...
describe('kingMovesBothDirections: false', () => {
    it('restricts kings to forward movement when disabled', () => {
        ...
        const bidirectional = legalMoves(state, makeConfig({ kingMovesBothDirections: true }));
        const forwardOnly = legalMoves(state, makeConfig({ kingMovesBothDirections: false }));
